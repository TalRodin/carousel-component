...
| **navigationPosition**      |             | 'bottom', 'bottom-left','bottom-right', 'top', 'top-left', 'top-right', 'left', 'left-top', 'left-bottom','right', 'right-top', 'right-bottom' | _Navigation Position_                                                                                                                                                                                                 |
...
| **mobileWidth**             |             | number                                                                                                                                         | _Width in the mobile version in `vw`_                                                                                                                                                                                 |
| **mobileHeight**            |             | number                                                                                                                                         | _Height in the mobile version in `vh`_                                                                                                                                                                                |
| **mobileBorderRadius**      |             | number                                                                                                                                         | _Mobile border radius in `px`_                                                                                                                                                                                        |
| **navigation**              |             | boolean                                                                                                                                        | _Add dot navigation_                                                                                                                                                                                                  |
| **dotMarginMobile**         |             | string                                                                                                                                         | _Margin around the buttons in mobile in `vw`. Ex.: '1 2 1 2' (top, right, bottom, and left), '1' is 1vw on top, bottom, left and right._                                                                              |
| **mobileDotSize**           |             | number                                                                                                                                         | _*Mobile size of navigation buttons in `px`*_                                                                                                                                                                         |
